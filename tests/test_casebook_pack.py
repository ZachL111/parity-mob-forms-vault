"""Regression checks for the parity-mob-forms-vault casebook."""
...
from casebook.harness import assert_expected, parity_mob_forms_vault_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(parity_mob_forms_vault_summary(), assert_expected())
